...
run:
	docker build -t "$(BASETAG):latest" . && docker run -p 8001:8001  --mount type=bind,source=/home/hoo/cos-mounts/visdemos-flyvec-osc,target=/app/data -t "$(BASETAG):latest"
